...
type sumBit<
  ...
  Sum extends Bit = _RT.Binary.XOR[_RT.Binary.XOR[A][B]][CarryIn],
  CarryOut extends Bit = _RT.Binary.OR[_RT.Binary.AND[A][B]][_RT.Binary.AND[CarryIn][_RT.Binary.XOR[A][B]]],
> = {
  sum: Sum;
  carryOut: CarryOut;
};
